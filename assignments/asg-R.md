# Title: Assignment 3: Graph and explore your dataset with R (due midnight Mon Sep 2) 
...
Answer all of the questions below inside your R Markdown document and check its output regularly by running the Knit function in R Studio. Make sure it is properly formatted and reads like a real report.
...
3. We will apply statistical tests to your dataset to gain insight in answering your questions. Start by first applying a correlation to detect a relationship and report statistics such as R^2 and _p_ values. Display the results by graphing the same variables using a scatter plot and add the regression line to it. Explain how the relationship aligns with your questions.
